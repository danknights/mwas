...
heatmap.3 <- function(x,
                      ...
                      rowAxisColors, # vector of colors for row labels
                      labRow = NULL,
                      labCol = NULL,
                      key = TRUE,
                      keysize = 1.5,
...
# 		iyix <- which(rowAxisColors %in% rowcolors[colorix])
#     	axis(4, iy[iyix], labels = labRow, las = 2, line = -0.5, tick = 0,
#         	cex.axis = cexRow, col.axis=rowcolors[colorix])
#     }
